        ...
        <div class="col-xs-6">
            <div class="box">
                ...
                <div class="box-header">
                    <h3 class="box-title">Данные Google аналитики</h3>
                </div>

                <div class="box-body table-responsive">
                    <form method="post" id="form" action="<?= ADMIN ?>/integration/google"
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <input type="text" name="tag_id" class="form-control" id="tag-id"
                                   placeholder="Google идентификатор" value="<?= $google->tag_id ?>">
